...
#include "../../TimerWidget/datetimewidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DateTimeWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 30, 0)
    ...
    "DateTimeWidget\0updateDateTime\0"
};
...
const QMetaObject DateTimeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DateTimeWidget.data,
      qt_meta_data_DateTimeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DateTimeWidget.stringdata))
